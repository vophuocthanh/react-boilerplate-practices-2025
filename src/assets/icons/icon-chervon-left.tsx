      ...
      >
        ...
        >
          <motion.rect
            ...
            initial='normal'
          />
          <motion.path variants={pathVariants} animate={controls} initial='normal' d='m12 8-4 4 4 4' />
          <motion.path variants={secondPathVariants} animate={controls} initial='normal' d='M16 12H8' />
        </svg>
      </div>
    )
  }
